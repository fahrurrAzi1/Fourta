    ...
    <div class="container-fluid">
        <div class="row no-gutters vh-100">
            <div class="col-lg-6 d-none d-lg-block bg-image"
                style="background-image: url('{{ asset('images/bgregisteradmin.svg') }}'); background-size: cover; background-position: center;">
            </div>
            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                <div class="container">
                    ...
                    <div class="text-center mb-4 d-lg-none">
                        <img src="{{ asset('images/bgregisteradmin.svg') }}" alt="Register Image" class="img-fluid" style="max-width: 300px;">
                    </div>
