...
class SoalControllerAdmin extends Controller
{
    ...
    public function skorHasil(Request $request)
    {
        ...
        return view('admin.presentase-hasil-admin', compact('results','kelass'));
    ...
    public function getResults()
    {
        ...
        $resultsAdmin = SkorJawaban::with(['siswa', 'komentar', 'soal'])->get();
        ...
        $groupedResults = $resultsAdmin->groupBy(function($item) {
